...
description: >
  Apple Design System skill for generating frontend UI code that faithfully reproduces Apple aesthetics (apple.com and Apple Human Interface Guidelines).
  Use when designing or auditing:
  1. Apple-style web interfaces, clean tables, landing pages, dashboards, or components
  2. Apple design tokens (typography, whitespace, restrained palettes, card radii, shadows)
  3. Polish and craft based on Apple Human Interface Guidelines
  Trigger: "apple design", "apple style", "apple ui", "design like apple"
---
