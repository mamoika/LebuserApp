-- Kierowca widzi wszystkie trasy i klientów w get_app_data.
-- Znosi stare ograniczenie filtrujące trasy wg users.routes.
-- Przypisana trasa jest oznaczana na froncie (gwiazdka/plakietka), a kierowca ma dostęp do wszystkich tras.
