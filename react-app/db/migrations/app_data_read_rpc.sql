-- ============================================================
--  Main app data read through a session-token RPC.
--
--  This is a non-breaking read-hardening step. The frontend can stop
--  selecting clients/routes/entries/laundry_receipts directly, while table
--  SELECT grants stay in place until all remaining direct reads are migrated.
-- ============================================================
